...
public class LevelFragment extends Fragment {
    ...
    static LevelFragment init(int color, String statusColor, Activity ac) {
        activity = ac;
        statusBarColor = statusColor;
        LevelFragment subjectChoiceFragment = new LevelFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layoutView = inflater.inflate(R.layout.s_fragment_level, container,
                false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        spinner = view.findViewById(R.id.spinner_level);
    ...
    public void setUserVisibleHint(boolean visible)
    {
        ...
        if (visible && isResumed())
        {
            ...
            getActivity().findViewById(R.id.first).setVisibility(View.GONE);
            onResume();
        }
    }
